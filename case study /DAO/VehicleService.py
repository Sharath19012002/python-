...
from Util.DBPropertyUtil import DBUtil
...
class VehicleService:
    ...
    def register_vehicle(self, vehicle_data):
        try:
            ...
            cursor.execute(query, (vehicle_data['vehicle_id'],vehicle_data['model'], vehicle_data['make'], vehicle_data['year'],
                                   vehicle_data['color'], vehicle_data['registration_number'],
                                   vehicle_data['availability'],
                                   vehicle_data['daily_rate']))

            connection.commit()
            return vehicle_data['vehicle_id']  # return the ID of the newly inserted vehicle
